<x-murid-layout>
    ...
    <div class="flex flex-col w-full p-6 space-y-4 sm:p-10">
            ...
            @foreach ($carts as $cart)
                <li class="flex flex-col py-6 sm:flex-row sm:justify-between">
                    <div class="flex w-full space-x-2 sm:space-x-4">
                        ...
                        src="https://source.unsplash.com/random/800x450/?ice-tea, {{ rand(1, 10) }}" alt="Polaroid camera">
                        <div class="flex flex-col justify-between w-full pb-4">
                            <div class="flex justify-between w-full pb-2 space-x-2">
                                <div class="space-y-1">
                                    <h3 class="text-lg font-semibold leading-snug sm:pr-8">Es Teh Hangat</h3>
                                    <p class="text-sm dark:text-gray-400">Bu Yuri</p>
                                </div>
                                <div class="text-right">
                                    <p class="text-lg font-semibold">Rp 3000</p>
        ...
        <div class="space-y-1 text-right">
            <p>Total Harga:
                <span class="font-semibold">Rp 9000</span>
            </p>
        ...
        <div class="flex justify-end space-x-4">
            ...
            <button type="button" class="px-6 py-2 border rounded-md dark:bg-violet-400 dark:text-gray-900 dark:border-violet-400">
                <span class="sr-only sm:not-sr-only">Checkout</span>
            </button>
        </div>
    </div>
</x-murid-layout>

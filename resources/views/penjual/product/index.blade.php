          ...
          <div class="mt-1 p-2">
            ...
            <div class="grid grid-cols-2 mt-3 flex items-center justify-between">
              ...
              <div class="flex ml-auto gap-1">
                <form action="{{ route('penjual.product.destroy', $product->id) }}" method="POST"  onsubmit="return confirm('Apakah anda yakin menghapus produk tersebut?');">
                  @method('delete')
                  @csrf
                  <div class="flex items-center rounded-lg bg-red-500 p-1.5 text-white duration-100 hover:bg-red-600">
                ...
                <div class="flex items-center rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">

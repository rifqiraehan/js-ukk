<div>
    <style>
        ...
        <center>
        <p class="mt-6 font-bold text-2xl py-4">Laporan Penjualan</p>
    </center>
        <div class="md:flex md:items-center grid justify-center md:justify-between no-print">
            <div class="inline-flex overflow-hidden bg-white border divide-x rounded-lg dark:bg-gray-900 rtl:flex-row-reverse dark:border-gray-700 dark:divide-gray-700 mb-2">
            ...
            <div>
                <a href="#" onclick="window.print(); return false;">
                    <center>
                    <button
                        class="flex items-center pl-3 justify-center w-1/2 px-5 py-1 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
        ...
        <div class="flex flex-col mt-6">
            <div class="-my-2 overflow-x-auto mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8 mb-8">
